...
run-api-test:
	...
	./etz api --workers=10 --config=examples/api/secret.yaml --helpers=examples/api/api.json --duration=10s --rps=50
	./etz api --workers=20 --config=examples/api/secret.yaml --helpers=examples/api/api.yaml --duration=10s -- rps=100
